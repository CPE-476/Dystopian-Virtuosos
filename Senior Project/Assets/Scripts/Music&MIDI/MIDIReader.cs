...
public class MIDIReader : MonoBehaviour
{
    ...
    */
    ...
    public void updateTrackState()
    {
        ...
        {
            StartCoroutine(tracksController.switchTrack(0.1f, 1));
        }
        else if (curVal.four.velocity == 2)
        {
            StartCoroutine(tracksController.switchTrack(0.1f, 2));
        }
        else if (curVal.four.velocity == 3)
        {
            StartCoroutine(tracksController.switchTrack(0.1f, 3));
        }
    }
}
